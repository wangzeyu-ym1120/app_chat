  ...
  <div class="register-container">
    ...
    <div class="input-container">
      <div class="input-item">
        <NInput placeholder="Plase Input Username" size="large" maxlength="20" style="--text-color:#fff;--caret-color:#fff;" v-model:value="registerInfos.username" @input="handlerInput($event, 'username')" @keyup.enter="register" >
          <template #prefix>
      ...
      <div class="input-item">
        <NInput placeholder="Plase Input Password" size="large" type="password" show-password-on="click" maxlength="18" style="--text-color:#fff;--caret-color:#fff;" v-model:value="registerInfos.password" @keyup.enter="register" >
          <template #prefix>
            <n-icon class="icon-container" size="20">
              <Key class="icon" />
            </n-icon>
